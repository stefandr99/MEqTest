        ...
        if($this->user->rowcount() === 0) {
            ...
            <div class = "profile-photo">
                ...
                <form action="" method="POST" enctype="multipart/form-data" onsubmit="prepareDiv();">
                    ...
                    <input class="profile-button" name="image" id="image" type="file" accept="image/*" multiple="multiple" onchange='loadFile(event); showFiles();' />
                    <input name="subButton" id="subButton" class="profile-button2" type="submit" value="Upload photo" />
                </form>
                </p>
